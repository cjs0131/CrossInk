...
EpdFont lato12RegularFont(&lato_12_regular);
EpdFont lato12BoldFont(&lato_12_bold);
EpdFont lato12ItalicFont(&lato_12_italic);
EpdFont lato12BoldItalicFont(&lato_12_bolditalic);
EpdFontFamily lato12FontFamily(&lato12RegularFont, &lato12BoldFont, &lato12ItalicFont, &lato12BoldItalicFont);
EpdFont lato14RegularFont(&lato_14_regular);
EpdFont lato14BoldFont(&lato_14_bold);
EpdFont lato14ItalicFont(&lato_14_italic);
EpdFont lato14BoldItalicFont(&lato_14_bolditalic);
EpdFontFamily lato14FontFamily(&lato14RegularFont, &lato14BoldFont, &lato14ItalicFont, &lato14BoldItalicFont);
...
void setupDisplayAndFonts(const bool seamless = false, const bool loadReaderResources = true) {
  ...
  renderer.insertFont(LATO_12_FONT_ID, lato12FontFamily);
  renderer.insertFont(LATO_14_FONT_ID, lato14FontFamily);
